    ...
    <nav>
        ...
        <section class="nav-items">
            <ul>
                ...
                <li><a href="./reviews.html" class="paragraph active">Reviews</a></li>
    ...
    <section class="reviews">
        <article class="reviews-card">
            ...
            <div class="card-footer">
                <h3 class="subheading blue">5 Stars</h3>
                <h2 class="heading">Nico - Creator of Elmira</h2>
                <p class="paragraph">I have had an excellent time working with Aidann after ordering a full game
                    package. He works fast, at a high quality and is very communicative. All at an absolute bargain
                    price, 5/5 &#9733; would recommend!</p>
            </div>
        </article>
        <article class="reviews-card">
